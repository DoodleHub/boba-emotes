const Privacy = () => {
  return (
    <div className="flex flex-col gap-4">
      <h1 className="text-2xl font-semibold">Privacy Policy for BobaEmotes</h1>
      <p>Welcome to Boba Emotes! Thanks for stopping by!</p>
      <p>
        We value your privacy. This Privacy Policy explains how we collect, use,
        disclose, and safeguard your information when you use our sticker app,
        BobaEmotes, available through the App Store. Please read this policy
        carefully. By using the app, you agree to the collection and use of
        information in accordance with this policy.
      </p>
      <p>
        Terms & Conditions These terms and conditions applies to the BobaEmotes
        app (hereby referred to as "Application") for mobile devices that was
        created by Cyndi Chin (hereby referred to as "Service Provider") as a
        Free service.
      </p>
      <p>
        ...
        attempts to copy designs, extract the source code of the Application,
      ...
      <p>
        We do not collect or store any personal data or sensitive information
        from users of our app. Since BobaEmotes is a sticker pack, it does not
        require access to any personal information such as names, email
        addresses, or locations. Our app does not use third-party analytics or
        advertising services that collect personal information.
      </p>
      <p>
        The Service Provider cannot always assume responsibility for your usage
        of the application. The Service Provider accepts no liability for any
      ...
      <p>
        ...
        periodically update their Terms and Conditions. Therefore, you are
        advised to review this page regularly for any changes. The Service
        Provider will notify you of any changes by posting the new Terms and
        Conditions on this page.
      </p>
      <p>These terms and conditions are effective as of 2024-09-19</p>
      <p>
